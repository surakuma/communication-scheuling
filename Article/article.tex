...
%% 	\subfloat[Optimal schedule]{
	    ...
	    \node[above right=0.8cm and 0cm of t1.mid, minimum height=0.5cm, minimum width=13cm, draw=white, fill=white](IMC) {$Infinite Memory Capacity$}; 	    		
...
%%		\draw[->] ([xshift=-0.1cm, yshift=-1cm] b11.south west)--([xshift=13cm, yshift=-1cm] b11.south west);
		...
		\draw[->] ([shift={(-0.1, -0.65)}] t1.mid)
             ...
             -- ([shift={(12, -0.65)}] t1.mid)node[legend,scale=0.5] {$12$}                                      
              --([shift={(17, -0.65)}] t1.mid)node[right,scale=0.5] {$t$};
...
%%      \node[above right=-1.15cm and -2cm of t1.mid, scale=1, rotate=0] {$Hello BCAD$};
 		...
 		\node(t1) at ([shift={(0, -3)}] t1.mid) {};   
	    \node[above right=0cm and 0cm of t1.mid, minimum height=0.5cm, minimum width=13cm, draw=white, fill=white](MC) {$Memory Capacity=6$}; 
	    

	    
	    
   		\node(t1) at ([shift={(0, -0.8)}] t1.mid) {};                		
		...
		-- ([shift={(9, -0.65)}] t1.mid)node[legend,scale=0.5] {$9$}
		-- ([shift={(12, -0.65)}] t1.mid)node[legend,scale=0.5] {$12$}         
		-- ([shift={(14, -0.65)}] t1.mid)node[legend,scale=0.5] {$14$}                                      
		-- ([shift={(15, -0.65)}] t1.mid)node[legend,scale=0.5]{$15$}
	  	-- ([shift={(17, -0.65)}] t1.mid)node[right,scale=0.5] {$t$};
...
%% schedule of third heuristic		
		...
		-- ([shift={(0, -0.65)}] t1.mid)node[legend,scale=0.5] {$0$}
		-- ([shift={(1, -0.65)}] t1.mid)node[legend,scale=0.5] {$1$}
		-- ([shift={(3, -0.65)}] t1.mid)node[legend,scale=0.5] {$3$}
		-- ([shift={(4, -0.65)}] t1.mid)node[legend,scale=0.5] {$4$}
		-- ([shift={(5, -0.65)}] t1.mid)node[legend,scale=0.5] {$5$}
		-- ([shift={(6, -0.65)}] t1.mid)node[legend,scale=0.5] {$6$}         
		-- ([shift={(8, -0.65)}] t1.mid)node[legend,scale=0.5] {$8$}                                      
		-- ([shift={(12, -0.65)}] t1.mid)node[legend,scale=0.5]{$12$} 
		-- ([shift={(16, -0.65)}] t1.mid)node[legend,scale=0.5] {$16$}
		--([shift={(17, -0.65)}] t1.mid)node[right,scale=0.5] {$t$};
...
%% schedule of fourth heuristic		
		...
		-- ([shift={(8, -0.65)}] t1.mid)node[legend,scale=0.5] {$8$}
		-- ([shift={(11, -0.65)}] t1.mid)node[legend,scale=0.5] {$11$}
		-- ([shift={(13, -0.65)}] t1.mid)node[legend,scale=0.5] {$13$}         
		-- ([shift={(14, -0.65)}] t1.mid)node[legend,scale=0.5] {$14$} 
		--([shift={(17, -0.65)}] t1.mid)node[right,scale=0.5] {$t$};
...
%% schedule of fifth heuristic		
		...
		\draw[->] ([shift={(-0.1, -0.65)}] t1.mid)
		-- ([shift={(0, -0.65)}] t1.mid)node[legend,scale=0.5] {$0$}
		-- ([shift={(2, -0.65)}] t1.mid)node[legend,scale=0.5] {$2$}
		-- ([shift={(3, -0.65)}] t1.mid)node[legend,scale=0.5] {$3$}
		-- ([shift={(6, -0.65)}] t1.mid)node[legend,scale=0.5] {$6$}
		-- ([shift={(8, -0.65)}] t1.mid)node[legend,scale=0.5] {$8$}
		-- ([shift={(12, -0.65)}] t1.mid)node[legend,scale=0.5] {$12$}         
...
%% schedule of sixth heuristic		
		...
		-- ([shift={(14, -0.65)}] t1.mid)node[legend,scale=0.5] {$14$}
		-- ([shift={(16, -0.65)}] t1.mid)node[legend,scale=0.5] {$16$} 
		-- ([shift={(17, -0.65)}] t1.mid)node[legend,scale=0.5] {$17$}  
		--([shift={(17.1, -0.65)}] t1.mid)node[right,scale=0.5] {$t$};
