...
%% schedule of third heuristic		
		...
		\node[above left=-0.15cm and 1cm of t1.mid, scale=1, rotate=0] {$BDAC$};
...
%% schedule of fourth heuristic		
		...
		\node[above left=-0.15cm and 1cm of t1.mid, scale=1, rotate=0] {$CBAD$};
...
%% schedule of fifth heuristic		
		...
		\node[above left=-0.15cm and 1cm of t1.mid, scale=1, rotate=0] {$DBAC$};
...
%% schedule of sixth heuristic		
		...
		\node[above left=-0.15cm and 1cm of t1.mid, scale=1, rotate=0] {$CABD$};
...
\begin{figure}[htb]
	...
	\node[above left=-0.15cm and 1cm of t1.mid, scale=1, rotate=0] {$BACD$};
...
\begin{figure}[htb]
	...
	\node[above left=-0.15cm and 1cm of t1.mid, scale=1, rotate=0] {$BDAEC$};
	...
	\node[above left=-0.15cm and 1cm of t1.mid, scale=1, rotate=0] {$BEADC$};
