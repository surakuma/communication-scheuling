...
\begin{document}
	...
	$C$. 
	\todo[inline]{SKumar: We do not need this assumption everywhere. CommVolume=CommTime is not true for experimental section. We used this assumption only in NP-hard proof.}
