...
%%	\todo[inline]{Find a citation saying 3-machine flowshop problem is NP-Complete.}
	...
	$C$. 
	\todo[inline]{SKumar: Why not a direct statement?  For simplicity, we assume in all of this paper that the amount of memory required by a task is equal to its communication volume.}
