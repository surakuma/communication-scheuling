...
facet_wrap(~aname, scale="free") + ylab("Ratio to Optimal") + xlab("Memory Capacity") + theme (legend.position="bottom")
#ggsave(file="test.pdf", p, width=7, height=4)
ggsave(file="ratio_to_optimal_batch-best.pdf",p, width=13, height=5)
